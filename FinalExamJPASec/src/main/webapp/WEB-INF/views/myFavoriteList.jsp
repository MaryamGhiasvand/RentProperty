		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="section-top-border" style="width: 100%;">
					<h3 class="mb-30">My favorite list</h3>
						...
						<div class="progress-table">
							...
							<c:forEach var="favoriteProperty" items="${favoriteProperties}">
								<div class="table-row">
									...
									<div class="country">${favoriteProperty.property.title}</div>
									<div class="visit">${favoriteProperty.property.description}</div>
									<div class="visit">${favoriteProperty.property.price}</div>
									<div class="visit">
										<a
											href=" <spring:url value="/favoriteProperties/removeFavorite?id=${favoriteProperty.id}" /> " Style="color:red">Delete</a>
									</div>
								</div>
							</c:forEach>
						</div>
